...
// Submit provides a mock function with given fields: ctx, endpoint, msg
func (_m *RestClient) Submit(ctx context.Context, endpoint string, msg protoiface.MessageV1) (*http.Response, error) {
	ret := _m.Called(ctx, endpoint, msg)
